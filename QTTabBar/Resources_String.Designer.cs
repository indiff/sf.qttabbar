...
namespace QTTabBarLib {
    ...
    public class Resources_String {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Go back;Go forward;Go back to start;Go forward to end;Select next tab;Select previous tab;Select first tab;Select last tab;Close current tab;Close all but current;Close left;Close right;Close window;Undo close;Clone current tab;Open current folder in new window;Lock / unlock current;Lock / unlock all;Browse folder;Create new group;Open option dialog;Show toolbar menu;Show current tab menu;Show group menu (Button Bar);Show recent folder menu (Button Bar);Show user application menu (Button Bar);Show / hide me [rest of string was truncated]&quot;;.
        /// </summary>

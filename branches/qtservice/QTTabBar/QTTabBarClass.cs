...
namespace QTTabBarLib {
    ...
    public sealed partial class QTTabBarClass : BandObject {
        ...
        private static void contextMenuNotifyIcon_SubItems_DropDownItemClicked(object sender, ToolStripItemClickedEventArgs e) {
            ...
            ShowTaskbarItem(tag, true);
            QTTabBarClass tabBar = InstanceManager.GetThreadTabBar(tag);
        ...
        private static void CreateContextMenuItems_NotifyIcon_Core(object sw, IntPtr hwndExplr) {
            ...
            foreach(IntPtr ptr in dicNotifyIcon.Keys) {
                ...
                // IM!
                /*
                QTTabBarClass tabBar = InstanceManager.GetThreadTabBar(ptr);
                if(tabBar != null) {
        ...
        private void MergeAllWindows() {
            ...
            try {
                ...
                foreach(IntPtr ptr2 in list) {
                    QTTabBarClass tabBar = InstanceManager.GetThreadTabBar(ptr2);
                    if(tabBar != null) {
        ...
        private void OpenDroppedFolder(IList<string> listDroppedPaths) {
                            ...
                            if(wrapper.IsLink) {
                                ...
                                using(IDLWrapper idlwTarget = new IDLWrapper(ShellMethods.GetLinkTargetIDL(path))) {
                                    if(idlwTarget.IsFolder && idlwTarget.IsReadyIfDrive) {
                                        ...
                                        if(fCtrl) {
                                            QTUtility.TMPIDLList.Add(idlwToNavigate.IDL);
                                        }
                                        else {
            ...
            if(fCtrl) {
                if(QTUtility.TMPIDLList.Count > 0) {
                    ...
                    using(IDLWrapper idlw = new IDLWrapper(QTUtility.TMPTargetIDL)) {
